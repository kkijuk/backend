...
public class FileController {
    ...
    public ResponseEntity<BaseResponse<Map<String,String>>> createFileUrl
        ...
        Map<String, String> response = fileService.getSignUrl(loginUser,fileName);
    ...
    public ResponseEntity<BaseResponse<FileResponse>> createFile
            (@Valid @RequestBody FileReqDto request) {
        Long loginUser = LoginUser.get().getId();
        FileResponse fileResponse = fileService.saveFile(loginUser,
                recordService.findByMemberId(loginUser).getId(), request);
        return ResponseEntity
                .status(HttpStatus.CREATED)
    ...
    public ResponseEntity<BaseResponse<Map<String,String>>> getDownloadUrl
            (@RequestParam String fileName) {
        Long loginUser = LoginUser.get().getId();
        Map<String, String> response = fileService.getDownloadUrl(loginUser, fileName);
    ...
    public ResponseEntity<BaseResponse<FileResponse>> deleteFile(@RequestParam String fileName){
        Long loginUser = LoginUser.get().getId();
        FileResponse fileResponse = fileService.deleteFile(loginUser, fileName);
    ...
    public ResponseEntity<Object> saveUrl(@RequestBody UrlReqDto urlReqDto){
        Long loginUser = LoginUser.get().getId();
        FileResponse fileResponse = fileService.saveUrl(loginUser,
                recordService.findByMemberId(loginUser).getId(), urlReqDto);
        return ResponseEntity
                .status(HttpStatus.OK)
    ...
    public ResponseEntity<Object> deleteUrl(@RequestBody UrlReqDto urlReqDto) {
        Long loginUser = LoginUser.get().getId();
        FileResponse fileResponse = fileService.deleteUrl(loginUser, urlReqDto);
        return ResponseEntity
                .status(HttpStatus.OK)
